<template>
  <el-card class="form-container" shadow="never">
    <el-form
      ...
      size="small"
    >
      <el-form-item label="名称：" prop="informationName">
      ...
      <el-form-item label="内容：" prop="informationName">
        <quill-editor :content="homeAdvertise.informationContent"></quill-editor>
      </el-form-item>
      <el-form-item>
