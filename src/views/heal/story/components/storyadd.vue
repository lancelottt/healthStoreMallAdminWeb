<template>
  <el-card class="form-container" shadow="never">
    <el-form
      ...
      size="small"
    >
      <el-form-item label="名称：" prop="storyTitle">
        <el-input v-model="homeAdvertise.storyTitle" class="input-width"></el-input>
      </el-form-item>
      <el-form-item label="来源：" prop="storyAuthor">
        <el-input v-model="homeAdvertise.storyAuthor" class="input-width"></el-input>
      </el-form-item>
