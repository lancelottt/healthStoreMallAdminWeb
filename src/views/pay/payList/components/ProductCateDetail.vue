<template>
	<div class="app-container">
		<el-row :gutter="20">
			<el-col :span="3">
				<div class="grid-content bg-purple">付费方案名称sddfsf:</div>
			</el-col>
			<el-col :span="4">
		...
		<el-row :gutter="20">
			<el-col :span="3">
				<div class="grid-content bg-purple">付费方案价格:</div>
			</el-col>
			<el-col :span="4">
				<el-input placeholder="请输入付费方案价格" v-model="input12" clearable>
				</el-input>
			</el-col>
		</el-row>
...
<script>
	import { proAddList, proTixingList, quedingAjax } from "@/api/paylist";
...
//			tixingList(t) {
//				this.nowObjArrayTi = t
//				console.log(this.nowObjArrayTi)
//			},
			closeDia() {
			...
			determine() {
				...
				const remind = {}
				remind.chargeSchemeName = this.input10  //用户付费方案
				remind.chargeSchemeDescribe = this.input11 //请输入付费方案描述
				remind.price = this.input12 //请输入付费方案价格
